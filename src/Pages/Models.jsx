...
import CarImg7 from "../images/cars-big/civic.jpg";
import CarImg8 from "../images/cars-big/Mustang.jpg";
import CarImg9 from "../images/cars-big/ModelS.jpg";
...
function Models() {
            ...
            <div className="models-div__box">
              <div className="models-div__box__img">
                ...
                <div className="models-div__box__descr">
                  ...
                  <div className="models-div__box__descr__name-price__details">
                    <span>
                      <i className="fa-solid fa-car-side"></i> &nbsp; Coupe
                    </span>
                    <span style={{ textAlign: "right" }}>
  ...
  <div className="models-div__box__img">
    ...
    <div className="models-div__box__descr">
      ...
      <div className="models-div__box__descr__name-price__details">
        <span>
          <i className="fa-solid fa-car-side"></i> &nbsp; Sedan
        </span>
        <span style={{ textAlign: "right" }}>
          4/5 &nbsp; <i className="fa-solid fa-car-side"></i>
        </span>
